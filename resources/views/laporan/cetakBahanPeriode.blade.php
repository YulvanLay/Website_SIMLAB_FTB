...
<html>
    <head>
        <title>Pemakaian Bahan Periode {{$periodes->nama_periode}}</title>
    ...
    <body>
        ...
        <div class="container-fluid p-3">
            ...
            <h3 class="text-center p-2" style="font-weight: bold; color: #038778;">Total Pemakaian Bahan per-Periode {{$periodes->nama_periode}}</h3>
