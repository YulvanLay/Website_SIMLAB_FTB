    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="white-space: nowrap;">
                ...
                @if(!$merek->bahans()->exists() && auth()->user()->hak_akses_delete)
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formTambah" action="{{ action('MerekBahanController@store') }}" method="POST">
                    @csrf
...
<script type="text/javascript">
    ...
    function showModalEdit(id){
        var urlUpdate = '{{ route("lainnya.MerekBahan.update", ":id") }}';
    ...
    function hapus(id){
        var url = '{{ action("MerekBahanController@destroy", ":id") }}';
